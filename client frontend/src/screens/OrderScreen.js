                    ...
                    {order.orderItems.map((item, index) => (
                      <div className="order-product row" key={index}>
                        ...
                        <div className="mt-3 mt-md-0 col-md-2 col-6 align-items-end  d-flex flex-column justify-content-center ">
                          <h4>SUBTOTAL</h4>
                          <h6>
                            <FormatPrice rupiah={item.qty * item.price} />
                          </h6>
                        </div>
                      </div>
                    ))}
                ...
                <table className="table table-bordered">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <FormatPrice rupiah={order.itemsPrice} />
                      </td>
                    </tr>
                    <tr>
                      {/* <td>
                      ...
                      <td>
                        <FormatPrice rupiah={order.shippingPrice} />
                      </td>
                    </tr>
                    <tr> */}
                      <td>
                      ...
                      <td>
                        <FormatPrice rupiah={order.taxPrice} />
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <FormatPrice rupiah={order.totalPrice} />
                      </td>
                    </tr>
                  </tbody>
                </table>
